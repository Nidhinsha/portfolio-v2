...
const PUBLIC_ID = import.meta.env.VITE_EMAILJS_PUBLIC_ID;
...
const Form = () => {
  ...
  // ✅ Step 3: Handle EmailJS submission
    ...
    <div>
      ...
      {popup.show && (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
          <div
            className={`bg-white text-center p-6 rounded-2xl shadow-xl w-[90%] max-w-sm ${
          ...
          >
            ...
            <button
              ...
              className="btn btn-sm btn-primary mt-4 rounded-md"
            >
              OK
            </button>
          </div>
