...
const workStepData = [
  {
    ...
    title: "Plan & Research",
    description:
      "I begin every project by deeply understanding user goals, technical needs, and business impact — ensuring the foundation is built on clarity and strategy.",
    svgPath:
  ...
  {
    id: 2,
    title: "Architect & Analyze",
    description:
      "Once the vision is clear, I focus on designing scalable architectures — defining APIs, data models, and clean backend logic using Node.js, TypeScript, and MongoDB.",
    svgPath:
  ...
  },
  {
    ...
    title: "Design & Build",
    description:
      "From architecture to implementation, I build responsive and performant UIs using React, MUI, and Redux Toolkit — always ensuring pixel-perfect design and seamless UX.",
    svgPath:
  ...
  },
  {
    ...
    title: "Test & Launch",
    description:
      "Before deployment, I rigorously test every module — optimizing performance, security, and scalability. I then deploy seamlessly using Docker, CI/CD, and GCP.",
    svgPath:
    ...
    >
      <div className="lg:pe-10 xl:pe-35.75 max-xs:mb-3 max-xl:mb-8">
        ...
        <p className="mt-6 mb-4 md:text-[18px] text-sm font-normal max-xl:text-center text-gray-500">
          I approach every project with a clear, structured workflow — from deep
          research to production-grade deployment. My process ensures code
          quality, scalability, and smooth collaboration across teams.
        </p>
        <p className="mt-6 md:text-[18px] text-sm font-normal max-xl:text-center text-gray-500">
          Each stage blends creativity with technical precision, resulting in
